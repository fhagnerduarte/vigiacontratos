...
<div class="card radius-8 border-0">
    <div class="card-body p-24">
        <h6 class="fw-semibold mb-24">Editar Secretaria</h6>

        <form action="{{ route('tenant.secretarias.update', $secretaria) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="row gy-3">
                <div class="col-md-8">
                    ...
                    <input type="text" name="nome" value="{{ old('nome', $secretaria->nome) }}"
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="sigla" value="{{ old('sigla', $secretaria->sigla) }}"
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="responsavel" value="{{ old('responsavel', $secretaria->responsavel) }}"
                ...
                <div class="col-md-4">
                    ...
                    <input type="email" name="email" value="{{ old('email', $secretaria->email) }}"
                ...
                <div class="col-md-2">
                    ...
                    <input type="text" name="telefone" value="{{ old('telefone', $secretaria->telefone) }}"
