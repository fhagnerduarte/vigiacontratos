...
@section('title', 'Relatorio de Auditoria')

@section('content')
<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
    <div>
        <h6 class="fw-semibold mb-4">Relatorio de Auditoria</h6>
        <p class="text-neutral-500 text-sm mb-0">Configure os filtros e gere o relatorio em PDF ou CSV</p>
    </div>
    ...
    <div class="card-body p-24">
        <form id="form-auditoria" method="POST">
            ...
            <div class="row g-16 mb-24">
                <div class="col-md-3">
                    <label class="form-label fw-semibold text-primary-light text-sm mb-4">Data Inicio *</label>
                ...
                <div class="col-md-3">
                    <label class="form-label fw-semibold text-primary-light text-sm mb-4">Tipo de Acao</label>
                    <select name="tipo_acao" class="form-select select2" data-placeholder="Todos">
                        <option value="">Todos</option>
                        <option value="alteracao" {{ old('tipo_acao') === 'alteracao' ? 'selected' : '' }}>Alteracoes</option>
                ...
                <div class="col-md-3">
                    <label class="form-label fw-semibold text-primary-light text-sm mb-4">Usuario</label>
            ...
            <div class="row g-16 mb-24">
                <div class="col-md-3">
                    ...
                    <select name="entidade" class="form-select select2" data-placeholder="Todas">
                        ...
                        <option value="user" {{ old('entidade') === 'user' ? 'selected' : '' }}>Usuario</option>
