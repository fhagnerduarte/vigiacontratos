...
<div class="card radius-8 border-0">
    <div class="card-body p-24">
        <h6 class="fw-semibold mb-24">Cadastrar Servidor</h6>

        <form action="{{ route('tenant.servidores.store') }}" method="POST">
            @csrf
            ...
            <div class="row gy-3">
                ...
                <div class="col-md-3">
                    ...
                    <div class="form-check form-switch mt-8">
                        ...
                        <input class="form-check-input" type="checkbox" name="is_ativo" value="1"
                               id="is_ativo" {{ old('is_ativo', '1') == '1' ? 'checked' : '' }}>
                ...
                <div class="col-12">
                    ...
                    <textarea name="observacoes" rows="3"
                              ...
                              placeholder="Observações adicionais sobre o servidor">{{ old('observacoes') }}</textarea>
                    @error('observacoes')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
