...
<div class="card radius-8 border-0">
    <div class="card-body p-24">
        <h6 class="fw-semibold mb-24">Editar Fornecedor</h6>

        <form action="{{ route('tenant.fornecedores.update', $fornecedor) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="row gy-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="representante_legal" value="{{ old('representante_legal', $fornecedor->representante_legal) }}"
                ...
                <div class="col-md-1">
                    ...
                    <input type="text" name="uf" value="{{ old('uf', $fornecedor->uf) }}"
                ...
                <div class="col-12">
                    ...
                    <textarea name="observacoes" rows="3"
                              ...
                              placeholder="Observacoes adicionais sobre o fornecedor">{{ old('observacoes', $fornecedor->observacoes) }}</textarea>
                    @error('observacoes')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
