...
<section class="auth bg-base d-flex flex-wrap">
    ...
    <div class="auth-right py-32 px-24 d-flex flex-column justify-content-center">
        <div class="max-w-464-px mx-auto w-100">
            ...
            <a href="{{ route('tenant.dashboard') }}" class="btn btn-primary text-sm btn-sm px-12 py-16 w-100 radius-12">
...
<script>
    ...
    function downloadCodes() {
        var text = '{{ config("app.name") }} - Códigos de Recuperação MFA\n';
        text += '='.repeat(50) + '\n\n';
        ...
        a.download = 'vigiacontratos-recovery-codes.txt';
        a.click();
