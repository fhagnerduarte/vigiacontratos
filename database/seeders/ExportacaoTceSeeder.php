    ...
    public function run(): void
    {
        ...
        $exportacoes = [
            [
                ...
                'gerado_por' => $user->id,
                'observacoes' => 'Exportação mensal para TCE - Janeiro/2026',
            ...
            [
                ...
                'gerado_por' => $user->id,
                'observacoes' => 'Contratos críticos para análise TCE',
            ...
            [
                ...
                'gerado_por' => $user->id,
                'observacoes' => 'Relatório completo para prestação de contas',
